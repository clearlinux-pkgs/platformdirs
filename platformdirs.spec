...
%prep
%setup -q -n platformdirs-2.3.0
cd %{_builddir}/platformdirs-2.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631208627
...
cp %{_builddir}/platformdirs-2.3.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/platformdirs/1a628675f3f38f1d4715ebd772a8160a0ea94dd4
